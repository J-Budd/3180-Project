...
Revision ID: 599ae27de998
Revises: 
Create Date: 2025-04-30 09:03:08.305554
...
def upgrade():
    ...
    sa.Column('parish', sa.String(length=255), nullable=True),
    sa.Column('biography', sa.String(), nullable=True),
    sa.Column('sex', sa.String(length=10), nullable=True),
    sa.Column('race', sa.String(length=10), nullable=True),
    sa.Column('birth_year', sa.Integer(), nullable=True),
    sa.Column('height', sa.Float(), nullable=True),
    sa.Column('fav_cuisine', sa.String(length=255), nullable=True),
    sa.Column('fav_color', sa.String(length=50), nullable=True),
    sa.Column('fav_school_subject', sa.String(length=255), nullable=True),
